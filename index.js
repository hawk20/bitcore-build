 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`ufocore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`ufocore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external ufocore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:ufocore-lib -o ufocore-lib.js';
    }
